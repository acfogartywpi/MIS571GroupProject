...
public class ChartGenerator {
    ...
    private static XYSeriesRenderer
    ...
    static {
        ...
        mRenderer.setYLabelsAlign(Align.
                RIGHT);
        mRenderer.setShowGridY(true);
        mRenderer.setXLabelsColor(Color.
                RED);
        mRenderer.setYLabelsColor(0, Color.
                RED);
    ...
    public static Intent getBarChart(Context context, String title,
        ...
        return ChartFactory.
                getBarChartIntent(context,
                        createDataSet(pairList),
                        mRenderer, BarChart.Type.
                                DEFAULT);
    }
    /**
     * Get a line chart
